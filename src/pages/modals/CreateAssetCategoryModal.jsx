...
const CreateAssetCategoryModal = ({ isOpen, onClose, onCategoryCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      setError("");
      const { data } = await assetCategoryAPI.create(formData);
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        <div className="flex justify-between items-center p-6 border-b" style={{ borderColor: themeColors.border }}>
          <h2 className="text-xl font-semibold" style={{ color: themeColors.text }}>Create Asset Category</h2>
