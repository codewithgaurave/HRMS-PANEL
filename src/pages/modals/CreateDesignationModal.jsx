// src/components/modals/CreateDesignationModal.jsx
import { useState } from "react";
import { useTheme } from "../../context/ThemeContext";
import designationAPI from "../../apis/designationAPI";
import { X } from "lucide-react";

const CreateDesignationModal = ({ isOpen, onClose, onDesignationCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await designationAPI.create(formData);
      ...
      setError(err.response?.data?.message || err.message || "Error creating designation");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      ...
      >
        ...
        <div className="flex justify-between items-center p-6 border-b" style={{ borderColor: themeColors.border }}>
          <h2 className="text-xl font-semibold">Create New Designation</h2>
          <button
            onClick={handleClose}
