// src/components/modals/CreateWorkShiftModal.jsx
import { useState } from "react";
import { useTheme } from "../../context/ThemeContext";
import workShiftAPI from "../../apis/workShiftAPI";
import { X, Clock } from "lucide-react";

const CreateWorkShiftModal = ({ isOpen, onClose, onWorkShiftCreated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await workShiftAPI.create(formData);
      onWorkShiftCreated();
      ...
      setError(err.response?.data?.message || err.message || "Error creating work shift");
    } finally {
      setLoading(false);
    }
  };
