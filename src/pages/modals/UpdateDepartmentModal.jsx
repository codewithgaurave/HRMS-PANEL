// src/components/modals/UpdateDepartmentModal.jsx
import { useState, useEffect } from "react";
import { useTheme } from "../../context/ThemeContext";
import departmentAPI from "../../apis/departmentAPI";
import { X } from "lucide-react";

const UpdateDepartmentModal = ({ isOpen, onClose, department, onDepartmentUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await departmentAPI.update(department._id, formData);
      onDepartmentUpdated(data.department);
      
    } catch (err) {
      setError(err.response?.data?.message || err.message || "Error updating department");
    } finally {
      setLoading(false);
    }
  };
