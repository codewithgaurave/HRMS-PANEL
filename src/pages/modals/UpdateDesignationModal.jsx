// src/components/modals/UpdateDesignationModal.jsx
import { useState, useEffect } from "react";
import { useTheme } from "../../context/ThemeContext";
import designationAPI from "../../apis/designationAPI";
import { X } from "lucide-react";

const UpdateDesignationModal = ({ isOpen, onClose, designation, onDesignationUpdated }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await designationAPI.update(designation._id, formData);
      onDesignationUpdated();
      
    } catch (err) {
      setError(err.response?.data?.message || err.message || "Error updating designation");
    } finally {
      setLoading(false);
    }
  };
