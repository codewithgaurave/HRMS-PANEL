// src/components/modals/UpdateEmploymentStatusModal.jsx
import { useState, useEffect } from "react";
import { useTheme } from "../../context/ThemeContext";
import employmentStatusAPI from "../../apis/employmentStatusAPI";
import { X, UserCheck } from "lucide-react";

const UpdateEmploymentStatusModal = ({ isOpen, onClose, employmentStatus, onEmploymentStatusUpdated }) => {
  ...
  useEffect(() => {
    if (employmentStatus) {
      setFormData({
        ...
        status: employmentStatus.status || "Active"
      });
    }
  }, [employmentStatus]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await employmentStatusAPI.update(employmentStatus._id, formData);
      onEmploymentStatusUpdated();
  ...
  if (!isOpen || !employmentStatus) return null;
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="Enter employment status title"
